...
class LoseState extends FlxState
{
	...
	override public function create():Void
	{
		...
		Registry.text = new FlxText(84,30,300,"You Lost!");
		Registry.text.size = 30;
		add(Registry.text); 
		
		var playerControl = Registry.score;
		
		Registry.text = new FlxText(84,200,300,"You lost with control of " + playerControl + " tokens!");
		Registry.text.size = 30;
		add(Registry.text); 
